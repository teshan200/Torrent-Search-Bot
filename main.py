...
DEFAULT_SEARCH_MARKUP = [
                    ...
                    [InlineKeyboardButton("Our Group : Film Upload", url="https://t.me/Filmmirrorchat")]
                ]
                        ...
                        InlineQueryResultArticle(
                            ...
                            input_message_content=InputTextMessageContent(
                                message_text=f"**Category:** `{torrentList[i]['Category']}`\n"
                                             ...
                                             f"**Magnet:**\n`{torrentList[i]['Magnet']}`\n\nDownload Torrents From @Filmmirrorchatt",
                                parse_mode="Markdown"
                            ),
                        ...
                        InlineQueryResultArticle(
                            ...
                            input_message_content=InputTextMessageContent(
                                message_text=f"**Genre:** `{torrentList[i]['Genre']}`\n"
                                             ...
                                             f"**Torrent Download Links:**\n{dl_links}\n\nDownload Torrents From @Filmmirrorchat",
                                parse_mode="Markdown",
                                disable_web_page_preview=True
                            ),
